...
<section class="section">
  <div class="container">
    <div class="glass reveal cta-metal" style="padding:clamp(36px,5vw,72px);border-radius:var(--r-xl);text-align:center;display:grid;gap:18px;justify-items:center;position:relative;overflow:hidden">
